...
public class ChristmasBush {
    ...
    public ChristmasBush() {
        img = getImage("/imgs/The_ChristmasBush.gif"); // Load the image file
    ...
    public ChristmasBush(int x, int y, int scaleX, int scaleY) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    //2nd constructor to initialize location and scale!
    public ChristmasBush(int x, int y, int scaleX, int scaleY, int vx, int vy) {
    	this();
    	this.x 		= x;
    	this.y 		= y;
    	this.scaleX = scaleX;
    ...
    private Image getImage(String path) {
        ...
        try {
            URL imageURL = ChristmasBush.class.getResource(path);
